        ...
        <div class="panel panel-info">
            ...
            <div class="visible-lg">
                <div class="btn-group  pull-right">
                    ...
                    <asp:LinkButton ID="btnSatis"
                        runat="server"
                        CssClass="btn btn-info"
                        Text="<i class='fa fa-shopping-cart'>Hızlı Satış/Servis</i>" OnClick="btnSatis_Click" />
                    <asp:LinkButton ID="btnKirala"
                        runat="server"
                        CssClass="btn btn-info"
                        Text="<i class='fa fa-cog'>Hızlı Kirala</i>" OnClick="btnKirala_Click" />
            ...
            <div class="pull-right visible-xs visible-sm">
                <div class="btn-group-justified ">
                    ...
                    <asp:LinkButton ID="btnKiralaK"
                        runat="server"
                        CssClass="btn btn-info"
                        Text="<i class='fa fa-cog'>Kirala</i>" OnClick="btnKirala_Click" />
        ...
        <div class="row">
            ...
            <div class="col-lg-3">
                <div class="alert alert-info text-center">
                    <i class="fa fa-calendar fa-3x" id="servisSayisi" runat="server"></i>&nbsp;İş/Şantiye
            ...
            <div class="col-lg-3">
                <div class="alert alert-success text-center">
                    <i class="fa  fa-thumbs-up fa-3x" id="onayBekleyen" runat="server"></i>&nbsp;Onay
                </div>
            </div>
            <div class="col-lg-3">
                <div class="alert alert-info text-center">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div id="panelServis" runat="server" visible="false" class="panel panel-info">
                    <div class="panel-heading">
                        <i class="fa fa-bar-chart-o fa-fw"></i>Açılan Son 10 Şantiye
                            <div class="pull-right">
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu pull-right" role="menu">
                                        <li><a id="linkServis" runat="server" href="/TeknikTeknik/ServislerCanli.aspx">Müşteri İş/Şantiyeleri</a>
                                        </li>
                                        <li><a id="linkServisEkle" runat="server" href="/TeknikTeknik/ServisEkle.aspx">Yeni İş/Şantiye</a>
                                        </li>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div id="panelKarar" runat="server" visible="false" class="panel panel-info">
                    <div class="panel-heading">
                        <i class="fa fa-bar-chart-o fa-fw"></i>Son on şantiye hesabı
                            <div class="pull-right">
                                <div class="btn-group">
                                    <button type="button" class="btn btn-default btn-xs dropdown-toggle" data-toggle="dropdown">
                                        İşlemler
                                ...
                                <div class="table-responsive">
                                    ...
                                    <asp:GridView ID="grdKarar" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered table-hover"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="toplam_maliyet" HeaderText="Maliyet" HeaderStyle-CssClass="visible-lg" ItemStyle-CssClass="visible-lg">
                                                <HeaderStyle CssClass="visible-lg" />
                                                <ItemStyle CssClass="visible-lg" />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="cihaz" HeaderText="Detay" HeaderStyle-CssClass="visible-lg" ItemStyle-CssClass="visible-lg">
                                                <HeaderStyle CssClass="visible-lg" />
                                                <ItemStyle CssClass="visible-lg" />
                                            </asp:BoundField>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div id="panelTamir" runat="server" visible="false" class="panel panel-info">
                    <div class="panel-heading">
                        <i class="fa fa-bar-chart-o fa-fw"></i>Aldığımız Son Hizmetler
                            <div class="pull-right">
                                <div class="btn-group">
                                    <button type="button" class="btn btn-default btn-xs dropdown-toggle" data-toggle="dropdown">
                                        İşlemler
                                ...
                                <div class="table-responsive">
                                    ...
                                    <asp:GridView ID="grdTamir" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered table-hover"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="toplam_maliyet" HeaderText="Yekün" HeaderStyle-CssClass="visible-lg visible-xs visible-sm" ItemStyle-CssClass="visible-lg visible-xs visible-sm">
                                                <HeaderStyle CssClass="visible-lg visible-xs visible-sm" />
                                                <ItemStyle CssClass="visible-lg visible-xs visible-sm" />
                                            </asp:BoundField>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div id="panelUrun" runat="server" visible="false" class="panel panel-info">
                    <div class="panel-heading">
                        <i class="fa fa-bar-chart-o fa-fw"></i>Müşteri Ürün/Malzeme
                            <div class="pull-right">
                                <div class="btn-group">
                                    <button type="button" class="btn btn-default btn-xs dropdown-toggle" data-toggle="dropdown">
                                        İşlemler
                                    ...
                                    <%--   <ul class="dropdown-menu pull-right" role="menu">
                                        <li><a id="linkCUrunAra" runat="server">Ürün/Malzeme Ara</a>
                                        </li>
                                            </ul>--%>
                                </div>
                            </div>
            ...
            <div class="modal-dialog modal-content modal-md">
                <div class="modal-header modal-header-info">
                    <button type="button" class="close" data-dismiss="modal"
                        aria-hidden="true">
                        ×</button>
                    <h3 id="onayModalLabel" class="baslik">Ürün/Mallzeme İade Bilgileri</h3>
                </div>
