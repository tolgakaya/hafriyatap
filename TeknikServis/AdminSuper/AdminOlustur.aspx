        ...
        <div class="panel panel-info">
            ...
            <div class="panel-body">
                ...
                <div class="form-horizontal">
                    ...
                    <div class="form-group">
                        <asp:Label runat="server" AssociatedControlID="lisanspaket" CssClass="col-md-2 control-label">Lisans Paket</asp:Label>
                        <div class="col-md-10">
                            <asp:DropDownList runat="server" ID="lisanspaket">
                                <asp:ListItem Text="Light Paket" Value="light" />
                                <asp:ListItem Text="Full Paket" Value="full" />
                            </asp:DropDownList>
                        </div>
                    </div>
                    <div class="form-group">
