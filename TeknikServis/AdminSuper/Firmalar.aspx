                    ...
                    <ContentTemplate>
                        ...
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-hover" DataKeyNames="id"
                            ...
                            <Columns>
                                    ...
                                    <ItemTemplate>
                                        <div class="visible-lg visible-xs visible-sm">
                                            <asp:LinkButton ID="btnEdit"
                                                ...
                                                CommandName="lisansla" CommandArgument='<%#Eval("id")+ ";" +Eval("config") + ";" + Container.DisplayIndex %>' Text="<i class='fa fa-pencil'></i>" />
                                            ...
                                            <asp:LinkButton ID="btnAdmin"
                                                runat="server"
                                                CssClass="btn btn-danger"
                                                CommandName="admin" CommandArgument='<%#Eval("config") %>' Text="<i class='fa fa-plus'></i>" />
                                ...
                                <asp:BoundField DataField="calismatipi" HeaderText="Çalışma Tipi" />
                                <asp:BoundField DataField="kullanicisinir" HeaderText="Kullanıcı Sınırı" />
                                <asp:BoundField DataField="makinesinir" HeaderText="Makine Sınırı" />
                          ...
                          <div class="modal-body">
                              <div class="form-horizontal">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <label for="calismatipi" class="col-md-2 control-label">Lisans (Light)</label>
                                      <div class="col-md-10">

                                          <asp:CheckBox ID="calismatipi" Text="Evet" CssClass="form-control" runat="server" />
                                      </div>
                                  </div>
                                  <div class="form-group">
                                      <asp:Label runat="server" AssociatedControlID="kullanicisinir" CssClass="col-md-2 control-label">Kullanıcı Sınır</asp:Label>
                                      <div class="col-md-10">
                                          <asp:TextBox runat="server" ID="kullanicisinir" CssClass="form-control" TextMode="Number" Text="1" />
                                          <asp:RequiredFieldValidator runat="server" ControlToValidate="kullanicisinir"
                                              CssClass="text-danger" ErrorMessage="Sınır field is required." />
                                      </div>
                                  </div>
                                  <div class="form-group">
                                      <asp:Label runat="server" AssociatedControlID="makinesinir" CssClass="col-md-2 control-label">Makine Sınır</asp:Label>
                                      <div class="col-md-10">
                                          <asp:TextBox runat="server" ID="makinesinir" CssClass="form-control" TextMode="Number" Text="5" />
                                          <asp:RequiredFieldValidator runat="server" ControlToValidate="makinesinir"
                                              CssClass="text-danger" ErrorMessage="Makine Sınır field is required." />
                                      </div>
                                  </div>
