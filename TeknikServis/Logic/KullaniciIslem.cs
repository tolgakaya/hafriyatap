...
namespace TeknikServis.Logic
{
    ...
    public static class KullaniciIslem
    {
        ...
        public static List<KullaniciRepo> FirmaOperatorleri()
        {
            HttpContext hcontext = HttpContext.Current;
            var manager = hcontext.GetOwinContext().GetUserManager<ApplicationUserManager>();
            ...
            // When creating the RoleManager object, you pass in (as a parameter) a new RoleStore object. 
            var roleMgr = new RoleManager<IdentityRole>(roleStore);
            List<IdentityUserRole> bayiler = roleMgr.FindByName("servis").Users.ToList();
            //userid ve roleid
        ...
        public static List<KullaniciRepo> FirmaOperatorleri(string s)
        {
            HttpContext hcontext = HttpContext.Current;
            var manager = hcontext.GetOwinContext().GetUserManager<ApplicationUserManager>();
            ...
            List<KullaniciRepo> liste = (from r in bayiler
                                         from u in userMgr.Users
                                         where r.UserId == u.Id && u.Firma == firma && u.UserName.Contains(s)
                                         select new KullaniciRepo
                                         {
                                             id = u.Id,
                                             email = u.Email,
        ...
        public static int kullaniciaktif()
        {
            HttpContext context = HttpContext.Current;
            var manager = context.GetOwinContext().GetUserManager<ApplicationUserManager>();
        ...
        public static IdentityResult updateKullanici(string id, string ad, string mail, string tel)
        {
            HttpContext context = HttpContext.Current;
            var manager = context.GetOwinContext().GetUserManager<ApplicationUserManager>();
        ...
        public static IdentityResult updateKullanici(string id, string ad, string mail, string sifre, string tel)
        {
            HttpContext context = HttpContext.Current;
            var manager = context.GetOwinContext().GetUserManager<ApplicationUserManager>();
