                    ...
                    <ContentTemplate>
                        ...
                        <asp:GridView ID="grdAlimlar" runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-hover" DataKeyNames="detay_id"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="adet_alinan" HeaderText="Miktar(Alış)"></asp:BoundField>
                                <asp:BoundField DataField="birim_alinan" HeaderText="Birim(Alış)"></asp:BoundField>
                                <asp:BoundField DataField="adet_satilan" HeaderText="Miktar(Satış)"></asp:BoundField>
                                <asp:BoundField DataField="birim_satilan" HeaderText="Birim(Satış)"></asp:BoundField>
