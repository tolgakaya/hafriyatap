    ...
    public partial class Stoklar : System.Web.UI.Page
    {
        ...
        protected void grdAlimlar_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName == "guncelle")
            {
                ...
                string alinan_id = Convert.ToString(arg[3]);
                string satilan_id = Convert.ToString(arg[4]);
                ...
                string sinir = row.Cells[12].Text;
                if (sinir.Equals("sinirsiz"))
                {
                    chcSinirsizUp.Checked = true;
                }
                else
                {
                    chcSinirsizUp.Checked = false;
                }
                drdGrupDuzen.SelectedValue = grupid;
                drdAlinanBirimUp.SelectedValue = alinan_id;
                drdSatilanBirimUp.SelectedValue = satilan_id;
