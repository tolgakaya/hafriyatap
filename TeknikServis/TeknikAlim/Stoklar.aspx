                    ...
                    <ContentTemplate>
                        <asp:GridView ID="grdAlimlar" runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-hover" DataKeyNames="ID"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderStyle-Width="120">
                                    <ItemTemplate>
                                        ...
                                        <asp:LinkButton ID="btnGuncelle"
                                            ...
                                            CommandName="guncelle" CommandArgument='<%#Eval("ID")+ ";" + Container.DisplayIndex +";"+Eval("grupid")+";"+Eval("alinan_birim_id")+";"+Eval("satilan_birim_id")  %>' Text="<i class='fa fa-pencil'></i>" />
                                ...
                                <asp:BoundField DataField="cihaz_adi" HeaderText="Ürün/Malzeme"></asp:BoundField>
                                ...
                                <asp:BoundField DataField="alinan_birim" HeaderText="Birim(Alış)" HeaderStyle-CssClass="visible-lg" ItemStyle-CssClass="visible-lg" />
                    ...
                    <ContentTemplate>
                        ...
                        <div class="modal-body">
                            <div class="form-horizontal">
                                ...
                                <div class="form-group">
                                    <div class="col-md-12">
                                        <asp:Label runat="server" AssociatedControlID="barcode" CssClass="control-label">Barkod</asp:Label>
            ...
            <div class="modal-dialog modal-content modal-md">
                <div class="modal-header modal-header-primary">
                    <button type="button" class="close" data-dismiss="modal"
                        aria-hidden="true">
                        ×</button>
                    <h4 id="updateModalLabel" class="baslik">Malzeme Güncelle</h4>
                </div>
                        ...
                        <div class="modal-body">
                            <div class="form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <asp:Label runat="server" AssociatedControlID="drdGrupDuzen" CssClass="control-label">Ürün Grubu</asp:Label>
                                ...
                                <div class="form-group">
                                    <div class="col-md-6">
                                        <asp:Label runat="server" AssociatedControlID="drdAlinanBirim" CssClass="control-label">Alımda Kullanılacak</asp:Label>
                                        <asp:DropDownList ID="drdAlinanBirimUp" CssClass="form-control" runat="server">
                                            <%--<asp:ListItem Text="Pos/Banka seçiniz" Value="-1"></asp:ListItem>--%>
                                        </asp:DropDownList>
                                    </div>
                                    <div class="col-md-6">
                                        <asp:Label runat="server" AssociatedControlID="drdSatilanBirim" CssClass="control-label">Satışta Kullanılacak</asp:Label>
                                        <asp:DropDownList ID="drdSatilanBirimUp" CssClass="form-control" runat="server">
                                            <%--<asp:ListItem Text="Pos/Banka seçiniz" Value="-1"></asp:ListItem>--%>
                                        </asp:DropDownList>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <asp:Label runat="server" AssociatedControlID="cihaz_adi_up" CssClass="control-label">Malzeme Tanımı</asp:Label>
                                ...
                                <div class="form-group">
                                    <div class="col-md-12">
                                        <asp:Label runat="server" AssociatedControlID="aciklama_up" CssClass=" control-label">Malzeme Açıklama</asp:Label>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <asp:Label runat="server" AssociatedControlID="barcode_up" CssClass="control-label">Barkod</asp:Label>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <asp:Label runat="server" AssociatedControlID="stok_up" CssClass="control-label">Stok Miktarı(Satış)</asp:Label>
                                        ...
                                        <asp:RangeValidator ErrorMessage="Küsuratlar için virgül kullanınız" ControlToValidate="stok_up" runat="server" Type="Currency" ValidationGroup="cihazGrup_up" MinimumValue="0" MaximumValue="99999" />
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <asp:Label runat="server" AssociatedControlID="maliyet_up" CssClass="control-label">Alış Fiyatı</asp:Label>
                                        ...
                                        <asp:RangeValidator ErrorMessage="Küsuratlar için virgül kullanınız" ControlToValidate="maliyet_up" runat="server" Type="Currency" ValidationGroup="cihazGrup_up" MinimumValue="0" MaximumValue="99999" />
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <asp:Label runat="server" AssociatedControlID="satis_up" CssClass="control-label">Satış Fiyatı</asp:Label>
                                        ...
                                        <asp:RangeValidator ErrorMessage="Küsuratlar için virgül kullanınız" ControlToValidate="satis_up" runat="server" Type="Currency" ValidationGroup="cihazGrup_up" MinimumValue="0" MaximumValue="99999" />

                                    </div>
                                </div>
                                <div class="form-group">
                                    <asp:Label runat="server" AssociatedControlID="chcSinirsizUp" CssClass="control-label col-md-2">Sınırsız Kaynak</asp:Label>
                                    <div class="col-md-10">
                                        <asp:CheckBox runat="server" ID="chcSinirsizUp" CssClass="form-control" />
                                    </div>
                                </div>
