    ...
    <div class="kaydir">
        <div class="panel panel-info">
            ...
            <div class="panel-heading">
                <h4 id="baslik" runat="server" class="panel-title">MÜŞTERİYE VERİLEN ÜRÜN VE MALZEMELER </h4>
            </div>
            ...
            <div class="table-responsive ">
                <div class="input-group custom-search-form">
                    <input runat="server" type="text" id="txtAra" class="form-control" placeholder="Ürün/Malzeme ismi giriniz..." />
                    ...
                    <ContentTemplate>
                        ...
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered table-hover" DataKeyNames="urunID"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="Cinsi" HeaderText="Malzeme" />
