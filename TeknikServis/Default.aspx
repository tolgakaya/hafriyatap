                    ...
                    <div class="table-responsive">
                        ...
                        <asp:UpdatePanel ID="upCrudGrid2" runat="server">
                            <ContentTemplate>
                                ...
                                <asp:Panel runat="server" ID="panelTamirci" DefaultButton="btnCihazAra">
                                        ...
                                        <div class="col-md-12">
                                            <asp:GridView ID="grdCihaz" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered table-hover" DataKeyNames="ID"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="satilan_birim" HeaderText="Birim" HeaderStyle-CssClass="visible-lg" ItemStyle-CssClass="visible-lg">
                                                        <HeaderStyle CssClass="visible-lg" />
                                                        <ItemStyle CssClass="visible-lg" />
                                                    </asp:BoundField>
                                                </Columns>
