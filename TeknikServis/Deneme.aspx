...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Button ID="btnServisHEsap" runat="server" CssClass="btn btn-success" Text="HEsap Test" OnClick="btnServisHEsap_Click" />


    <asp:Button ID="btnServisOnay" runat="server" CssClass="btn btn-success" Text="Onay Test" OnClick="btnServisOnay_Click" />
    <asp:Button ID="btnMakine" runat="server" CssClass="btn btn-success" Text="Makine" OnClick="btnMakine_Click" />

    <asp:TextBox runat="server" ID="txtSonNumara" CssClass="form-control" />
    <asp:TextBox runat="server" ID="txtYeniNumara" CssClass="form-control" />
    <asp:TextBox runat="server" ID="txtDakika" CssClass="form-control" />
    <asp:TextBox runat="server" ID="txtSaatBilgi" CssClass="form-control" />
