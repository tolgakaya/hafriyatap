...
namespace TeknikServis.Admin
{
    public partial class Kullanicilar1 : System.Web.UI.Page
    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            string tel = txtTelefonEdit.Text;
            ...
            {
                sonuc = KullaniciIslem.updateKullanici(id, kullanici, eposta, yeniSif, tel);
            }
            else
            {
                sonuc = KullaniciIslem.updateKullanici(id, kullanici, eposta, tel);
            }
        ...
        protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            else if (e.CommandName.Equals("editRecord"))
            {
                ...
                txtTelefonEdit.Text = HttpUtility.HtmlDecode(gvrow.Cells[4].Text);
