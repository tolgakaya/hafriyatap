                              ...
                              <div class="form-horizontal">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-md-10">
                                       ...
                                       <div class="form-group">
                                      <asp:Label runat="server" AssociatedControlID="txtTelefonEdit" CssClass="col-md-2 control-label">EPosta</asp:Label>
                                      <div class="col-md-10">
                                          <asp:TextBox runat="server" ID="txtTelefonEdit" TextMode="Number" CssClass="form-control" />
                                          <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ValidationGroup="musteriGrup" ControlToValidate="txtTelefonEdit" ErrorMessage="Geçerli bir telefon giriniz."></asp:RequiredFieldValidator>
