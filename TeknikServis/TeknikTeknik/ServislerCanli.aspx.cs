...
namespace TeknikServis
{
    public partial class ServislerCanli : System.Web.UI.Page
    {
        ...
        protected void GridView1_OnRowCreated(Object sender, GridViewRowEventArgs e)
        {
            ...
            {
                (e.Row.FindControl("btnServis") as LinkButton).PostBackUrl = "~/TeknikTeknik/Servis2.aspx?servisid=" + DataBinder.Eval(e.Row.DataItem, "serviceID") + "&custid=" + DataBinder.Eval(e.Row.DataItem, "custID") + "&kimlik=" + DataBinder.Eval(e.Row.DataItem, "kimlikNo");
        ...
        protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            else if (e.CommandName.Equals("editRecord"))
            {
                ...
                custIDHdn.Value = HttpUtility.HtmlDecode(gvrow.Cells[11].Text);
                txtmusteriAdi_3.Text = HttpUtility.HtmlDecode(gvrow.Cells[4].Text);
                txtAciklama_4.Text = HttpUtility.HtmlDecode(gvrow.Cells[5].Text);


                //txtServisTipi_7.Text = HttpUtility.HtmlDecode(gvrow.Cells[10].Text);
                drdTip.SelectedValue = HttpUtility.HtmlDecode(gvrow.Cells[10].Text);
