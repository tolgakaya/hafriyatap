    ...
    <div class="kaydir">
        ...
        <div class="panel panel-info">
            <div class="panel-heading">
                HIZLI MALZEME/HİZMET SATIŞ KAYDI
            </div>
            <div class="panel-body">
                <div class="panel panel-info">
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <a data-toggle="collapse" data-parent="#accordion" href="#collapseThere" class="collapsed">Malzeme Seçimi</a>
                        </h4>
                    </div>
                                    ...
                                    <ContentTemplate>
                                        ...
                                        <asp:GridView ID="grdCihaz" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered table-hover" DataKeyNames="ID"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Ürün/Malzeme Adı" HeaderStyle-CssClass="visible-lg visible-xs visible-sm" ItemStyle-CssClass="visible-lg visible-xs visible-sm">
                                        ...
                                        <asp:Button ID="btnAddCihaz" runat="server" Text="Yeni Ürün/Malzeme" CssClass="btn btn-primary"
                                    ...
                                    <div class="modal-dialog modal-content modal-sm">
                                        <div class="modal-header modal-header-info">
                                            <button type="button" class="close" data-dismiss="modal"
                                                aria-hidden="true">
                                                ×</button>
                                            <h3 id="addModalLabel" class="baslik">Yeni Ürün/Malzeme</h3>
                                        </div>
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="form-horizontal">
                                                        ...
                                                        <div class="form-group">
                                                            <asp:Label runat="server" AssociatedControlID="txtCihazAdi" CssClass="col-md-10 control-label">Ürün/Malzeme Adı</asp:Label>
                                                            <div class="col-md-10">
                                ...
                                <div class="panel-body">
                                    <div class="form-horizontal">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <asp:TextBox ID="txtAdet" runat="server" Text="1" CssClass="form-control" AutoPostBack="true" OnTextChanged="txtFiyatMalzeme_TextChanged"></asp:TextBox>
                                                <asp:RangeValidator ID="RangeValidator4" runat="server" ControlToValidate="txtAdet" Type="Currency" ValidationGroup="valGrup" CssClass="text-danger" MaximumValue="9999" MinimumValue="0" ErrorMessage="Ondalık sayılar için virgül kullanınız."></asp:RangeValidator>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                <asp:RangeValidator ID="RangeValidator3" runat="server" ControlToValidate="txtFiyatMalzeme" Type="Currency" ValidationGroup="valGrup" CssClass="text-danger" MaximumValue="9999" MinimumValue="0" ErrorMessage="Ondalık sayılar için virgül kullanınız."></asp:RangeValidator>

                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label" for="txtCihazAdiGoster">Ürün/Malzeme</label>
                                            <div class="col-sm-10">
