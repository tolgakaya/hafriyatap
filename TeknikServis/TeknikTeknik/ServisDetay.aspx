...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function UploadPic(ress) {
            ...
            var dataParam = '{' + '"imageData": "' + Pic + '", "ress": "' + ress + '", "servis": "' + servis + '", "aciklama": "' + aciklama + '", "baslik": "' + baslik + '", "kullanici": "' + kullanici + '"' + '}';
            ...
            if (baslik || aciklama) {
                ...
                $.ajax({
                    ...
                    success: function (msg) {
                        ...
                        var url = "/TeknikTeknik/Servis?custid=" + custid + "&servisid=" + servis  + "&kimlik=" + kimlik  + "&eleman=" + gorevli;
