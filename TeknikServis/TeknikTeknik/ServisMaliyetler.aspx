                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <asp:DropDownList ID="drdKritik" runat="server" class="form-control">
                                    <asp:ListItem Text="Açık İş/Şantiyeler" Value="acik"></asp:ListItem>
                                    <asp:ListItem Text="Tamamlanan İşler" Value="tamam"></asp:ListItem>
                        ...
                        <div class="table-responsive">
                            <div id="info" class="col-sm-12">
                                <div class="btn-group  pull-right">
                                    ...
                                    <asp:LinkButton ID="btnServis"
                                        ...
                                        Text="<i class='fa fa-wrench'>İş/Şantiye</i>" />
                            ...
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered table-hover"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="dakika" HeaderText="Dakika" HeaderStyle-CssClass="visible-lg visible-xs visible-sm" ItemStyle-CssClass="visible-lg visible-xs visible-sm">
                                        <HeaderStyle CssClass="visible-lg visible-xs visible-sm" />
                                        <ItemStyle CssClass="visible-lg visible-xs visible-sm" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="tarife" HeaderText="Tarife" HeaderStyle-CssClass="visible-lg visible-xs visible-sm" ItemStyle-CssClass="visible-lg visible-xs visible-sm">
                                        <HeaderStyle CssClass="visible-lg visible-xs visible-sm" />
                                        <ItemStyle CssClass="visible-lg visible-xs visible-sm" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="sure" HeaderText="Çalışma Süresi" HeaderStyle-CssClass="visible-lg visible-xs visible-sm" ItemStyle-CssClass="visible-lg visible-xs visible-sm">
                                        <HeaderStyle CssClass="visible-lg visible-xs visible-sm" />
                                        <ItemStyle CssClass="visible-lg visible-xs visible-sm" />
                                    </asp:BoundField>
