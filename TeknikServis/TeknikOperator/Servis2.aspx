<%@ Page Title="" Language="C#" MasterPageFile="~/TeknikOperator/Operator.Master" AutoEventWireup="true" CodeBehind="Servis2.aspx.cs" Inherits="TeknikServis.TeknikOperator.Servis2" %>
    ...
    <div class="kaydir">
        <div class="panel-group" id="accordionik">
            ...
            <div id="Div2" runat="server" class="panel panel-info">
                <div class="panel-heading">
                    <h2 class="panel-title">
                        <a data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" class="collapsed">Makine Hesapları</a>
                    </h2>
                </div>
