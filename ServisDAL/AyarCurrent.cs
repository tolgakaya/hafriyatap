...
namespace ServisDAL
{
    public class AyarCurrent
    {
        ...
        //buradaki çalışma tipini light versiyon olarak düzenliyorum
        //yani çalışma tipi true ise light versiyon kullanıyor olacak
        public bool calismaTipli()
        {
            return this.get().calismatipi;

        }
        public int kullanicisinir()
        {
            return this.get().kullanicisinir;

        }
        public int makinesinir()
        {
            return this.get().makinesinir;
