...
namespace ServisDAL
{
    public class FaturaBas
    {
        ...
        public extre ExtreBilgileri(int custid, int gun, ayargenel ay)
        {
            ...
            IEnumerable<CariDetayYeni> alimlar = from s in dc.alims
                                                 where s.iptal == false && s.CustID == custid && s.alim_tarih >= tarih
                                                 select new CariDetayYeni
                                                 {
                                                     MusteriID = s.CustID,
                                                     aciklama = s.aciklama,
    ...
    public class extre
    {
        ...
        public decimal donem_borc { get; set; }
        public decimal donem_alacak { get; set; }
    ...
    public class Servis_Baslama
    {
        ...
        public List<MakineServisToplami> makine_calismalari { get; set; }

    }

    public class MakineServisToplami
    {
        public int id { get; set; }
        public int makine_id { get; set; }
        public string makine_plaka { get; set; }
        public decimal calisma_saati { get; set; }
        public decimal toplam_dakika { get; set; }
    ...
    public class Servis_Hesap
    {
        ...
        public string adet_detay { get; set; }
        public decimal tutar { get; set; }
        public string aciklama { get; set; }
        public DateTime tarih { get; set; }
    }
