...
namespace ServisDAL
{
    public class FaturaPrinter
    {
        ...
        public void BaslamaBas(Servis_Baslama servisBilgileri, DevExpress.XtraReports.Web.ASPxDocumentViewer gosterge)
        {
            ...
            m.bindingSource1.DataSource = servisBilgileri;

            m.DetailReport.DataSource = m.bindingSource1;
            m.DetailReport.DataMember = "makine_calismalari";

            m.DetailReport1.DataSource = m.bindingSource1;
            m.DetailReport1.DataMember = "kararlar";
            ...
            m.tip.Text = "İş tipi: " + servisBilgileri.tip;
            ...
            m.islem.DataBindings.Add("Text", m.bindingSource1, "kararlar.islem");
            m.cihaz.DataBindings.Add("Text", m.bindingSource1, "kararlar.cihaz");
            m.fiyat.DataBindings.Add("Text", m.bindingSource1, "kararlar.fiyat");
            m.tutar.DataBindings.Add("Text", m.bindingSource1, "kararlar.tutar");
            m.aciklamaHesap.DataBindings.Add("Text", m.bindingSource1, "kararlar.tarih");
            m.adet.DataBindings.Add("Text", m.bindingSource1, "kararlar.adet");

            m.makine_plaka.DataBindings.Add("Text", m.bindingSource1, "makine_calismalari.makine_plaka");
            m.yekun.DataBindings.Add("Text", m.bindingSource1, "makine_calismalari.yekun");
            m.toplam_dakika.DataBindings.Add("Text", m.bindingSource1, "makine_calismalari.toplam_dakika");
            m.calisma_saati.DataBindings.Add("Text", m.bindingSource1, "makine_calismalari.calisma_saati");
            m.tarife_kodu.DataBindings.Add("Text", m.bindingSource1, "makine_calismalari.tarife_kodu");
